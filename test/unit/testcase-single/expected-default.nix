{
  ...
  let
    ...
    dependencies = [
          { url = "https://repo1.maven.org/maven2/com/google/guava/guava/32.1.2-jre/guava-32.1.2-jre.jar"; hash = "sha256-8qHz5qHl+NWy48TVprfI2eDxorPE1eb3qLnA0eLzpLU="; }
    ];
